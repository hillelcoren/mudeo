...
const String kAppVersion = '0.0.59+59';
...
const String kMudeoGoogleStoreUrl =
...
const String kDanceGoogleStoreUrl =
    'https://play.google.com/store/apps/details?id=app.mudeo.dancelikeme';
...
const int kMillisecondsToRefreshData = 1000 * 60 * 120; // 120 minutes
const int kMillisecondsToRetryData = 1000 * 15; // 10 seconds
const int kMaxRecordsPerApiPage = 50;
const int kMaxTracks = 5;
const int kMaxSongDuration = 5 * 60 * 1000; // 5 minutes
